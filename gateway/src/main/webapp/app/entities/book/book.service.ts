...
export class BookService {
    ...
    private resourceUrl =  SERVER_API_URL + 'bookstore/api/books';
    ...
    private convertItemFromServer(book: Book): Book {
        ...
        copy.publishedOn = this.dateUtils
            .convertDateTimeFromServer(book.publishedOn);
        return copy;
    }
    ...
    private convert(book: Book): Book {
        ...
        copy.publishedOn = this.dateUtils.toDate(book.publishedOn);
        return copy;
    }
}
